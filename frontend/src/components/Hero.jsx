  ...
  return (
    <div className="hero">
      <div className="hero-content">
        ...
        {isSearching && <p className="search-feedback">Buscando los mejores autos para ti...</p>}
      </div>
      <style>{`
        ...
        .search-feedback { margin-top: 20px; font-weight: 600; color: white; animation: pulse 1.5s infinite; }
